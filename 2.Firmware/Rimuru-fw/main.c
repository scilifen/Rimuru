...
int main(void)
{
	...
	// gpio_init(KEY2, GPI, GPIO_LOW, GPI_ANAOG_IN); // 初始化 KEY2 输入 默认高电平 上拉输入
	// gpio_init(KEY3, GPI, GPIO_LOW, GPI_FLOATING_IN); // 初始化 KEY3 输入 默认高电平 上拉输入
	// gpio_init(KEY4, GPI, GPIO_LOW, GPI_PULL_DOWN); // 初始化 KEY4 输入 默认高电平 上拉输入
